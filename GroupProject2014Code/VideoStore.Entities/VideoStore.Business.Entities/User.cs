...
namespace VideoStore.Business.Entities
{
    ...
    public partial class User: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<Review> Review
        {
            get
            {
                if (_review == null)
                {
                    _review = new TrackableCollection<Review>();
                    _review.CollectionChanged += FixupReview;
                }
                return _review;
            }
            set
            {
                if (!ReferenceEquals(_review, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    OnNavigationPropertyChanged("Review");
                }
            }
        }
        private TrackableCollection<Review> _review;
        ...
        private void FixupReview(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (Review item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("Review", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Review item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("Review", item);
                    }
                }
            }
        }
